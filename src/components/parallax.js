...
export default props => (
    <Parallax
        ...
        strength={400}
    >
      <div className="main-title-section" style={{ height: `${props.galleryHeight}` }}
        data-sal-duration="1700" data-sal="slide-down" data-sal-delay="200" data-sal-easing="easeInOutCubic">
